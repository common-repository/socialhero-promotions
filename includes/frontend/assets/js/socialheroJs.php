...
<script type="text/javascript">
  ...
  function listenForError() {
    var errorElement = document.getElementsByClassName('woocommerce-error');
    if (errorElement.length < 1) {
      setTimeout(listenForError(100))
    } else {
      errorElement[0].remove();
    }
  }

 window.onload = listenForError
</script>
