<?php
 ...
 $product_info = [];
  ...
  $checkDiscountStatus = $wpdb->get_results($wpdb->prepare("SELECT discount_status FROM $spTableName WHERE code = '".$code."' "));
 ?>
...
<div class="socialhero-api">
    ...
    <div class="socialHeroApiInner">
        ...
        <p style='margin-top: 15px;font-size: 14px;display:none'>¿No estás afiliado? Afiliación gratuita en <a
        href='https://www.socialhero.com.mx/afiliate' target='_blank' style='color:
        #5F4690;display:none'>https://www.socialhero.com.mx/afiliate</a></p>
    </div>
</div>
